...
def main():
    trainval_nusc = NuScenes(version='v1.0-mini',
                             dataroot='./data/frontier_nuScenes/',
                             verbose=True)
    # train_scenes = splits.train
    # val_scenes = splits.val
    val_scenes = splits.mini_train
    print(val_scenes)
    # train_infos_tiny = generate_info(trainval_nusc, train_scenes[:2])
    # mmcv.dump(train_infos_tiny, './data/frontier_nuScenes/nuscenes_infos_train-tiny.pkl')
    # train_infos = generate_info(trainval_nusc, train_scenes)
    # mmcv.dump(train_infos, './data/frontier_nuScenes/nuscenes_infos_train.pkl')
    val_infos = generate_info(trainval_nusc, val_scenes)
    mmcv.dump(val_infos, './data/frontier_nuScenes/nuscenes_infos_val.pkl')
    ...
    # mmcv.dump(test_infos, './data/frontier_nuScenes/nuscenes_infos_test.pkl')
