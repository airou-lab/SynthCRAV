...
SPLIT = 'v1.0-mini'
DATA_PATH = 'data/frontier_nuScenes'
OUT_PATH = 'radar_bev_filter'
info_paths = ['data/frontier_nuScenes/nuscenes_infos_val.pkl']


# SPLIT = 'v1.0-trainval'
# DATA_PATH = 'data/frontier_nuScenes'
# OUT_PATH = 'radar_bev_filter'
# info_paths = ['data/frontier_nuScenes/nuscenes_infos_train.pkl', 'data/frontier_nuScenes/nuscenes_infos_val.pkl']

# # uncomment if testing
# SPLIT = 'v1.0-test'
# DATA_PATH = 'data/frontier_nuScenes'
# OUT_PATH = 'radar_bev_filter_test'
# info_paths = ['data/frontier_nuScenes/nuscenes_infos_test.pkl']
