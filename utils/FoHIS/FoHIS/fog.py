...
import os
from depth_estim import *

np.set_printoptions(threshold=np.inf)
np.errstate(invalid='ignore', divide='ignore')

# load rgb and depth image
img = './img/n015-2018-07-24-11-22-45+0800__CAM_FRONT__1532402927612460.jpg'
Ip = cv2.imread(img)

model, transform = load_torch_model()
filename = img.split('/')[-1].split('.')[0]
generate_depth_map(Ip,filename,model,transform)
