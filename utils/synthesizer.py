...
from .utils import cart_to_polar, polar_to_cart
# from utils.fisheye import generate_fisheye_dist

'''
Contains the synthesizer functions within the deform_data class
'''
...
class deform_data():
    ...
    # def superfish(self,img,auto_resize=False): #Futur work
    ...
    def deform_image(self,img,deform_type):
        ...
        # if deform_type == 'superfish':# Future work
        #     if self.verbose:
